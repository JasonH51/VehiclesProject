...
public class Car extends Vehicle implements IDisplayInfo {
	private String make;
	...
	public Car(int numOfDoors, int numOfWheels, int topSpeed, String transmissionType, String make, String model,
